...
plot(pred_tt,main="Evolution des trajectoires pour le tour de taille",lty=1,legend=NULL,ylab="tour de taille(cm)")
...
plot(pred_mm_sex,main="Evolution des trajectoires pour la masse musculaire",lty=1,legend=NULL,ylab="masse musculaire(%)")
legend(x="bottomleft",legend=paste0("class",1:3,"(",round(s_mm_sex["model_mm_sex_3",][5:7],2),"%",")"),lty = 1,col=1:3)
```
